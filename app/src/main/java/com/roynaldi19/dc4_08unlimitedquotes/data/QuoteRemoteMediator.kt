...
import com.roynaldi19.dc4_08unlimitedquotes.database.RemoteKeys
...
class QuoteRemoteMediator(
    ...
    override suspend fun load(
        ...
        val page = when (loadType) {
            LoadType.REFRESH -> {
                val randomKeys = getRemoteKeyClosestToCurrentPosition(state)
                randomKeys?.nextKey?.minus(1) ?: INITIAL_PAGE_INDEX
            }
